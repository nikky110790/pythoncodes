...
# Split the words into each word and iterate
words = speech.split()

# # Printing the words which contain x in it from the total speech

# print("Words containing 'x' in the total speech")

# for word in words:
#     if "x" in word.lower():
#         print(word)

# # Printing the words which contain j in it from the total speech

# print("\n\nWords containing 'j' in the total speech")

# for word in words:
#     if "j" in word.lower():
#         print(word)

# Working the same in list comprehensions
a = [word for word in words if "j" in word.lower()]
